    ...
    <div class="flex flex-col">
        <div class="p-1.5 px-4 min-w-full inline-block align-middle">
            <div class="flex flex-col md:flex-row justify-between mb-6 mx-8">
                <a href="{{ route('admin.Create-Supplier') }}" class="bg-green-600 hover:bg-green-700 shadow-md py-2 px-4 rounded-md mb-4 md:mb-0 text-center">Add Supplier</a>
                ...
                <div class="relative w-full md:w-auto">
                    <form action="{{ route('admin.Supplier') }}" method="get">
                        <input
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 font-medium text-center text-gray-500 uppercase">Supplier Name</th>
                            <th scope="col" class="px-6 py-3 font-medium text-center text-gray-500 uppercase">Address</th>
                            <th scope="col" class="px-6 py-3 font-medium text-center text-gray-500 uppercase">Phone Number</th>
                            <th scope="col" class="px-6 py-3 font-medium text-center text-gray-500 uppercase">Email</th>
                            <th scope="col" class="px-6 py-3 font-medium text-center text-gray-500 uppercase">Action</th>
                        </tr>
                    </thead>
                    <tbody class="min-w-full divide-y divide-gray-200 pr-12">
                        @foreach ($supplier as $supplier)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center font-medium text-gray-800">{{ $supplier->Nama_Supplier }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-gray-800">{{ $supplier->Alamat }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-gray-800">{{ $supplier->Telepon }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-gray-800">{{ $supplier->Email }}</td>
                                <td class="py-4 whitespace-nowrap text-center font-medium flex justify-center">
                                    <div class="flex justify-end">
                                        <div>
                                            <a href="{{ route('admin.Edit-Supplier', $supplier->id) }}"
                                        ...
                                        <div>
                                            <form action="{{ route('admin.Delete-Supplier', ['id' => $supplier->id]) }}" method="post" onsubmit="return confirm('Are You Sure Wanna Delete It?')">
                                                @csrf
                                                @method('DELETE')
                                                <button
